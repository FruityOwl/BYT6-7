...
public class Money implements Comparable<Money> {
    ...
    public Boolean equals(Money other) {
        return (int) (amount / currency.getRate()) == (int) (other.amount / other.currency.getRate());
    }
    ...
    public Money add(Money other) {
        return new Money((int) ((amount / currency.getRate() + other.amount / other.currency.getRate()) * currency.getRate()), currency);
    }
	...
	public int compareTo(Money other) {
		double difference = universalValue() - other.universalValue();
		if (difference == 0) {
			return 0;
